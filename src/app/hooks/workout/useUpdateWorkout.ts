...
/**
 * 기존 운동을 업데이트하는 SWR Mutation 훅.
 *
 * @param {string | null} id - 업데이트할 운동의 ID. null일 경우 요청을 보내지 않습니다.
 * @returns {{
 *   updateWorkout: (data: any) => Promise<any>; // SWRMutation의 trigger 함수 (업데이트할 데이터 전달)
